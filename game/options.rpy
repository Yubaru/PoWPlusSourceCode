...
define config.name = "Doki Doki Paradise of Wacko Plus!"
...
define config.version = "1.0.0 Pre-Alpha"
...
define build.name = "DDPoWPlusSourceCode"
...
#   Linux: $HOME/.renpy/
define config.save_directory = "DDPoWPlus"

# This controls the window logo of your mod.
define config.window_icon = "gui/window_icon.png"

if persistent.christmas_mode:
    config.window_icon "gui/window_icon_jolly.png"
else:
