init -100 python in phone.discussion:
    ...
    def _discussion_coroutine():
        ...
        # Play typing sound if this is a text message
        if payload.type == TEXT and renpy.loadable("mod_assets/sfx/message_typing.ogg"):
            renpy.play("mod_assets/sfx/message_typing.ogg", channel="sound")
    ...
    def register_message(group, sender, text):
        ...
        # Play send sound when message is registered
        if renpy.loadable("mod_assets/sfx/message_send.ogg"):
            renpy.play("mod_assets/sfx/message_send.ogg", channel="sound")
